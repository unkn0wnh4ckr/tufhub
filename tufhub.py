...
def billcipher():
  def back():
      print()
      back = raw_input('\033[92mDo you want to continue? [Yes/No]: ')
      if back[0].upper() == 'Y':
          print()
          iseeverything()
      elif back[0].upper() == 'N':
  ...
  def iseeverything():
      try:
          what = raw_input('\033[92mAre you want to collect information of website or IP address? [W/I]: ')
          if what[0].upper() == 'W':
              victim = raw_input('Enter the website address: ')
              banner()
          elif what[0].upper() == 'I':
              victim = raw_input('Enter the IP address (or domain to get IP address of this domain): ')
          ...
          choose = raw_input('What information would you like to collect? (1-20): ')
...
def blackhydra():
  ...
  os.system("clear")
  print R+"___  _    ____ ____ _  _    _  _ _   _ ___  ____ ____"
  print "|__] |    |__| |    |_/     |__|  \_/  |  \ |__/ |__|"
  print B+"|__] |___ |  | |___ | \_    |  |   |   |__/ |  \ |  |"
  print G+"-----------------------------------------------------"
...
def cupp():
  os.system("cd /root/tufhub/wordlists && cupp -i")
...
def password():
  ...
  print "[5]  facebook"
  print "[6]  hashcat"
  print "[7]  Black-Hydra [noob friendly hydra]"
  print "[8]  cupp [makes wordlists into directory /root/tufhub/wordlists]"
  print G+"-" * 100
...
def shellphish():
  os.system("chmod +x /root/tufhub/other/shellphish * && bash /root/tufhub/other/shellphish/shellphish.sh")
def instaspam():
  os.system("chmod +x /root/tufhub/other/instaspam * && bash /root/tufhub/other/instaspam/instaspam.sh")
def userrecon():
  os.system("chmod +x /root/tufhub/other/userrecon * && bash /root/tufhub/other/userrecon/userrecon.sh")
def fastssh():
  print """
 ______  _____         _   ____ ____  _   _
 \ \ \ \|  ___|_ _ ___| |_/ ___/ ___|| | | |
  \ \ \ \ |_ / _` / __| __\___ \___ \| |_| |
  / / / /  _| (_| \__ \ |_ ___) |__) |  _  |
 /_/_/_/|_|  \__,_|___/\__|____/____/|_| |_| v1.0

  Author: thelinuxchoice (Github/Instagram)

Usage: [FASTSSH]> --scan / --bruteforcer
  """
  ssh = raw_input("\033[91m[FASTSSH]\033[0m> ")
  os.system("chmod +x /root/tufhub/other/fastssh * && bash /root/tufhub/other/fastssh/fastssh.sh " + ssh)
def other():
  otherbanner()
  print G+"-" * 100
  print r+"[1]  shellphish"
  print "[2]  Instaspam [comment spam]"
  print "[3]  userrecon"
  print "[4]  fastssh"
  print G+"-" * 100
  other = raw_input("[OTHER] \033[94m->: \033[0m")
  if other == "1" :
    shellphish()
  if other == "2" :
    instaspam()
  ...
  if other == "exit" :
    ...
    print r+"no option called ", R+other
    os.system("sleep 2")
    os.system("clear")
    mainbanner()  
