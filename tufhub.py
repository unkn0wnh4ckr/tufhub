...
def shellphish():
  os.system("chmod +x /root/tufhub/other/shellphish * && cd /root/tufhub/other/shellphish && ./shellphish.sh")
def instaspam():
  os.system("chmod +x /root/tufhub/other/instaspam * && cd /root/tufhub/other/instaspam && ./instaspam.sh")
def userrecon():
  os.system("chmod +x /root/tufhub/other/userrecon * && cd /root/tufhub/other/userrecon && ./userrecon.sh")
def fastssh():
  os.system("chmod +x /root/tufhub/other/fastssh * && cd /root/tufhub/other/fastssh && ./fastssh.sh")
def other():
  otherbanner()
  print G+"-" * 100
