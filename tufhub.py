...
def shellphish():
  os.system("chmod +x /root/shellphish * && bash /root/shellphish/shellphish.sh")
def instaspam():
  os.system("chmod +x /root/instaspam * && bash /root/instaspam/instaspam.sh")
def userrecon():
  os.system("chmod +x /root/userrecon * && bash /root/userrecon/userrecon.sh")
def fastssh():
  print """
...
Usage: [FASTSSH]> --scan / --bruteforcer
  ...
  os.system("chmod +x /root/fastssh * && bash /root/fastssh/fastssh.sh " + ssh)
def other():
  otherbanner()
  print G+"-" * 100
