...
def shellphish():
  os.system("cd /root/shellphish && chmod +x * && bash shellphish.sh")
def instaspam():
  os.system("cd /root/instaspam && chmod +x * && bash instaspam.sh")
def userrecon():
  os.system("cd /root/userrecon && chmod +x * && bash userrecon.sh")
def fastssh():
  print """
...
Usage: [FASTSSH]> --scan / --bruteforcer
  ...
  os.system("cd /root/fastssh && chmod +x * && bash fastssh.sh" + ssh)
def other():
  otherbanner()
  print G+"-" * 100
