...
def shellphish():
  os.system("cd /root/tufhub/other/shellphish && ./shellphish.sh")
def instaspam():
  os.system("cd /root/tufhub/other/instaspam && ./instaspam.sh")
def userrecon():
  os.system("cd /root/tufhub/other/userrecon && ./userrecon.sh")
def fastssh():
  os.system("cd /root/tufhub/other/fastssh && ./fastssh.sh")
def other():
  print G+"-" * 100
